...
if (!empty($_POST)) {
  ...
  if(empty($_POST['terms'])){
    $errors['terms'] = "Please acceot the terms and conditions!";
  }
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
  ...
  <main class="form-signin w-100 m-auto">
    <form method="post">
      <img class="mb-4 rounded-circle shadow" src="assets/images/logo.jpg" alt="" width="70" height="68">
      <h1 class="h3 mb-3 fw-normal">Create Account</h1>
      <?php if(!empty($errors)):?>
      <div class="alert alert-danger">Please fix the Errors Below!</div><?php endif;?>
